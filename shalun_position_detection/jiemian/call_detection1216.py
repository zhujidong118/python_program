...
class MyMainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def slot_init(self):
        ...
        '初始化显示截取图像'
        show = cv2.imread("E:\\python\\shalun_position_detection\\pic_data\\wait_detection\\jiequ.jpg")
        ...
        '初始化显示拟合图'
        show = cv2.imread("E:\\python\\shalun_position_detection\\pic_data\\result_detection\\nihe.png")
        showImage = self.show_image(show)
...
class param2(QtWidgets.QDialog, Ui_Dialog_jiequ):
    ...
    def initui(self):
        ...
        self.label.setGeometry(QRect(20, 10, 960, 720))
        ...
        # print(self.label.mousePressEvent())
