...
class MyMainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def slot_init(self):
        ...
        '初始化显示截取图像'
        show = cv2.imread("E:\\python\\shalun_position_detection\\pic_data\\wait_detection\\jiequ2.jpg")
    ...
    def show_jiequ(self):
        if self.camera_state == 1:
            ...
            if result == 1:
                ...
                # image = self.image[dialog.label.x0 * 3:dialog.label.x1 * 3, dialog.label.y0 * 3:dialog.label.y1 * 3]
